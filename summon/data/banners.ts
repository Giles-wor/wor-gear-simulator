...
const placeholderBanners: Record<BannerConfig['id'], BannerConfig> = {
  ...
  limited: {
    ...
    placeholder: false,
    notes:
      '한정 5성 1명 선택 (콜라보 영웅 미나 제외). 선택 영웅 ×20 + ×10 stacking + 200픽 자체 확정. 스피릿 천장은 다른 스피릿 배너와 공유. (현재 한정 영웅: 카이난.)',
  },
  ancient: {
    id: 'ancient',
    ...
    placeholder: false,
    notes:
      '고대 소환: 보장 천장 2개(독립 카운터). ① 영주(알수없는자 포함) 0.8%, 185회 미획득 후 +8%/회, 200픽 확정. ② 일반 레전더리(영주·알수없는자 제외) 1%, 130회 미획득 후 +5%/회, 150픽 확정. ×20 픽업 + ×2 stacking. 보통 영주+일반 각 1명씩 픽업. (2026-06-29 풀 조정: 비주류 영주/알수없는자 7명 제외 → 영주 풀 8명. 그룹 0.72%는 유지되어 영주 1명당 확률은 상승.) (2026-07: 지제벨(영주) 추가 → 영주 풀 9명.) (2026-07-18 인게임 풀 개편: 주류 영주 대거 편입 → 영주 0.72%×9 → 0.8%×16, 일반 30→28.)',
  },
  divine: {
    id: 'divine',
